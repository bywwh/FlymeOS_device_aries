...
#-----------------------------------------------------------------------------
#vendor_remove_dirs := system/supersu
...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt CaptivePortalLogin Ds DsUI KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
